...
namespace leave_management2.Services
{
    //  There already is a pre-coded one of these, we're overriding it!
    ...
    public class EmailSender : IEmailSender
    {
        ...
        //  The IOptions is comming from the appsettings.json email info.
        ...
        public async Task SendEmailAsync(string email, string subject, string htmlMessage)
        {
            ...
            try
            {
                //  Choose "using MailKit" here, not "System.Net.Mail"
